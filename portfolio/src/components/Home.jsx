...
const Home = () => {
  return (
    <Container className=" position-relative vertical-center-container">
      <Row>
        ...
        <Col className="p-3 ps-5 bg-color template-secondary">
          ...
          <p className="text-second">
            ...
            altamente efficiente, dotato di un computer di ultima generazione e
            una configurazione a doppio schermo che mi consente di massimizzare
            la produttività. Questo mi permette di gestire compiti complessi con
            rapidità e precisione. La mia motivazione è intrinsecamente legata
            alla crescita professionale. Attualmente, sto lavorando per
            diventare un esperto nel settore dello sviluppo Full Stack e sto
            ampliando le mie conoscenze anche nell'ambito dell'Intelligenza
            Artificiale (AI). Credo che la combinazione di queste competenze mi
            renderà un professionista più completo e preparato per affrontare le
            sfide del futuro.
          </p>
          ...
          <Row>
            ...
            <Col xs={6}>
              ...
              <div className="text-second">
                Ho la capacità di migliorare le prestazioni delle applicazioni,
                riducendo i tempi di caricamento e l'utilizzo delle risorse.
              </div>
            </Col>
            <Col className="mt-3">
              <div className="fs-3">🛡️</div>
              ...
              <div className="text-second">
                Ho esperienza nella protezione delle applicazioni web da minacce
                comuni attraverso strumenti come bcrypt, JWT, e nella creazione
                di meccanismi di sicurezza robusti.
              </div>
            </Col>
            <Col className="mt-3">
              <div className="fs-3">📚</div>
